...
**Mission:** Execute the Failure Analysis responsibility within the Evaluation domain flawlessly.
...
**Prompt Template:** `19_Prompts/evaluation/failure_analysis_prompt.md`
